...
DEFAULT_ADMIN = True  # CREATE A DEFAULT ADMIN ACCOUNT AT USER DATABASE CREATION
DEFAULT_ADMIN_USERNAME = "admin"  # DEFAULT ADMIN USERNAME
DEFAULT_ADMIN_EMAIL = "admin@flaskblog.com"  # DEFAULT ADMIN MAIL ADRESS
DEFAULT_ADMIN_PASSWORD = "admin"  # DEFAULT ADMIN PASSWORD
DEFAULT_ADMIN_POINT = 0  # DEFAULT ADMIN POINT SCORE
DEFAULT_ADMIN_PROFILE_PICTURE = f"https://api.dicebear.com/7.x/identicon/svg?seed={DEFAULT_ADMIN_USERNAME}&radius=10"  # DEFAULT ADMIN PROFILE PICTURE
...
RECAPTCHA_BADGE = False  # TURN ON/OFF RECAPTCHA VERIFICATION HTML BADGE.
